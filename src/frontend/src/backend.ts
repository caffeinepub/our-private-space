...
import type { ChatMessage as _ChatMessage, ExternalBlob as _ExternalBlob, MediaReference as _MediaReference, MessageId as _MessageId, MessageInput as _MessageInput, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getDeletedMessageIds(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDeletedMessageIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: MessageInput): Promise<MessageId> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(await to_candid_MessageInput_n20(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MediaReference_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaReference): Promise<MediaReference> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MediaReference]): Promise<MediaReference | null> {
    return value.length === 0 ? null : await from_candid_MediaReference_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        media: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.media)),
...
async function to_candid_MediaReference_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MediaReference): Promise<_MediaReference> {
    return await to_candid_record_n23(_uploadFile, _downloadFile, value);
}
async function to_candid_MessageInput_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MessageInput): Promise<_MessageInput> {
...
async function to_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        media: value.media ? candid_some(await to_candid_MediaReference_n22(_uploadFile, _downloadFile, value.media)) : candid_none(),
        content: value.content
    };
}
